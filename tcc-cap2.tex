...
Somente após um longo período de pesquisas e testes \emph{in-silico} e \emph{in-vivo}, estabelecendo eficácia e segurança, o novo fármaco é submetido para registro no órgão regulador.

A Tabela \ref{tab:rddtempo} apresenta, de uma forma geral, as etapas e o tempo que contemplam o processo de desenvolvimento de um novo fármaco \cite{kun92}.
